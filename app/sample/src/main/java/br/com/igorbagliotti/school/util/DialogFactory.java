...
public final class DialogFactory {
    ...
    public static Dialog createSimpleOkDialog(Context context, String title, String message, DialogInterface.OnClickListener listener) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(context).setTitle(title).setMessage(message).setNeutralButton(R.string.dialog_action_ok, listener);
        return alertDialog.create();
    }

    public static Dialog createGenericErrorDialog(Context context, String message) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(context, R.style.AppCompatAlertDialogErrorStyle).setTitle(context.getString(R.string.lbl_error_generic_api)).setMessage(message).setNeutralButton(R.string.dialog_action_ok, null);
        return alertDialog.create();
    }
    ...
    public static Snackbar showErrorSnackBar(Context mContext, View rootView, Throwable throwable) {
        String message = mContext.getString(R.string.lbl_error_generic_api);
        if (throwable != null) {
